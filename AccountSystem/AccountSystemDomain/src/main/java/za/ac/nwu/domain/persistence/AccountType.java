...
public class AccountType implements Serializable{
    ...
    @Id
    @SequenceGenerator(name = "DEMO_ACCOUNT_TYPE_GENERIC_SEQ", sequenceName = "CMPG323.DEMO_ACCOUNT_TYPE_GENERIC_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DEMO_ACCOUNT_TYPE_GENERIC_SEQ")
